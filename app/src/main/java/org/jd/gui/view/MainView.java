...
public class MainView<T extends JComponent & UriGettable> implements UriOpenable, PreferencesChangeListener {
    ...
    public MainView(
        ...
        invokeLater(() -> {
            ...
            Action findNextAction2 = newAction("Find Next", false, findNextActionListener);
            Action findPreviousAction2 = newAction("Find Previous", false, findPreviousActionListener);
            ...
            menu.add(findNextAction2).setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F3, 0));
            menu.add(findPreviousAction2).setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F3, InputEvent.SHIFT_MASK));
            ...
            // Register F3 / Shift+F3 as global frame-wide shortcuts for Find Next / Find Previous
            JRootPane rootPane = mainFrame.getRootPane();
            rootPane.getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW)
                    .put(KeyStroke.getKeyStroke(KeyEvent.VK_F3, 0), "MainView.findNext");
            rootPane.getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW)
                    .put(KeyStroke.getKeyStroke(KeyEvent.VK_F3, InputEvent.SHIFT_MASK), "MainView.findPrevious");
            rootPane.getActionMap().put("MainView.findNext",     findNextAction2);
            rootPane.getActionMap().put("MainView.findPrevious", findPreviousAction2);
